...
import createProjectExtractor, {
    type CreateProjectExtractorOptions,
    type ProjectExtractor,
} from './create-project-extractor'

type CoveredTypes = [CreateProjectExtractorOptions, ProjectExtractor]
