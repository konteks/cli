...
import { generateTargetEmbeddings } from '@/app/providers/ai/embedding-pipeline'
...
import { mineChunks } from '@/app/providers/mining/engine/chunk-store'
import type { ScannedFile } from '@/app/providers/mining/engine/file-scan'
import { scanProjectFilesWithDiagnostics } from '@/app/providers/mining/engine/file-scan'
import type {
    MineManifest,
    MineMode,
} from '@/app/providers/mining/engine/manifest'
import {
    readMineManifest,
    writeMineManifest,
} from '@/app/providers/mining/engine/manifest'
import { extractProjectMetadata } from '@/app/providers/mining/engine/metadata'
import type { MineProgressReporter } from '@/app/providers/mining/engine/progress'
import { formatProjectSummaryToon } from '@/app/providers/mining/engine/toon-summary'
import type { TreeSitterEngine } from '@/app/providers/mining/engine/tree-sitter-engine'
import { createToonStore } from '@/app/providers/storage/toon-store'
