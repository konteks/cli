...
import { generateTargetEmbeddings } from '@/app/services/ai/embedding-pipeline'
import { mkdir } from '@/app/services/file-manager'
import { mineChunks } from '@/app/services/mining/engine/chunk-store'
import type { ScannedFile } from '@/app/services/mining/engine/file-scan'
import { scanProjectFilesWithDiagnostics } from '@/app/services/mining/engine/file-scan'
import type {
    MineManifest,
    MineMode,
} from '@/app/services/mining/engine/manifest'
import {
    readMineManifest,
    writeMineManifest,
} from '@/app/services/mining/engine/manifest'
import { extractProjectMetadata } from '@/app/services/mining/engine/metadata'
import type { MineProgressReporter } from '@/app/services/mining/engine/progress'
import { formatProjectSummaryToon } from '@/app/services/mining/engine/toon-summary'
import type { TreeSitterEngine } from '@/app/services/mining/engine/tree-sitter-engine'
