import { generateTargetEmbeddings } from '@/app/ai/embedding-pipeline'
...
import { mineChunks } from '@/app/mining/engine/chunk-store'
import type { ScannedFile } from '@/app/mining/engine/file-scan'
import { scanProjectFilesWithDiagnostics } from '@/app/mining/engine/file-scan'
import type { MineManifest, MineMode } from '@/app/mining/engine/manifest'
import {
    readMineManifest,
    writeMineManifest,
} from '@/app/mining/engine/manifest'
import { extractProjectMetadata } from '@/app/mining/engine/metadata'
import type { MineProgressReporter } from '@/app/mining/engine/progress'
import { formatProjectSummaryToon } from '@/app/mining/engine/toon-summary'
import type { TreeSitterEngine } from '@/app/mining/engine/tree-sitter-engine'
