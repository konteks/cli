...
import { callMcpToolCommand } from '@/app/controllers/call-mcp-tool'
import { getPromptDetailCommand } from '@/app/controllers/get-prompt-detail'
import { getPromptsCommand } from '@/app/controllers/get-prompts'
import { getStatusCommand } from '@/app/controllers/get-status'
import { getToolDetailCommand } from '@/app/controllers/get-tool-detail'
import { getToolsCommand } from '@/app/controllers/get-tools'
import { initCommand } from '@/app/controllers/init'
import { installSkillsCommand } from '@/app/controllers/install-skills'
import { repairCommand } from '@/app/controllers/repair'
