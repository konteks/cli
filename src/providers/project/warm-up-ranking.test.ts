...
import type { WarmUpObservationRow } from './warm-up-ranking'
import {
...
type CoveredTypes = [WarmUpObservationRow]
...
describe('providers/project/warm-up-ranking', () => {
    ...
    it('compiles observation row type contracts', () => {
        type _Covered = CoveredTypes
        const typeNames = ['WarmUpObservationRow'] as const
        expect(typeNames).toEqual(['WarmUpObservationRow'])
    })
})
